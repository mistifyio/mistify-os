...
ID=$(http POST guests --data-binary '{"metadata": { "foo": "bar"}, "memory": 256, "cpu": 2, "nics": [ { "model": "virtio", "address": "10.10.10.10", "netmask": "255.255.255.0", "gateway": "10.10.10.1", "network": "br0"} ], "disks": [ {"image": "linux-test"}, {"size": 512} ] }' | jq -r .id)
